...
public class UserConstants
{
    ...
    public static final String SALE_USER_TYPE = "02";
    public static final String CUSTOMER_USER_TYPE = "03";

    /**
     * 审核状态
     */
    public static final Integer SYS_AUDIT_WAIT = 1;
    public static final Integer SYS_AUDIT_PASS = 2;
    public static final Integer SYS_AUDIT_REFUSE = 3;
